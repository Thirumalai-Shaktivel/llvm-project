...
OpenMPIRBuilder::InsertPointOrErrorTy OpenMPIRBuilder::createTask(
    ...
    Value *Priority, SmallVector<DependData> Dependencies, bool Mergeable,
    Value *EventHandle) {
  ...
  OI.PostOutlineCB = [this, Ident, Tied, Final, IfCondition, Priority,
                      Dependencies, Mergeable, EventHandle, TaskAllocaBB,
    ...
    if (Priority) {
      ...
      Value *taskGEP = Builder.CreateInBoundsGEP(taskPtr, TaskData,
      ...
      Value *priorityData = Builder.CreateInBoundsGEP(taskStructType, taskGEP,
